...
const Contact = () => {
  ...
  return (
    <section className="w-full  text-white px-6 lg:py-16 md:pb-10 pb-6 ">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-300 text-lg">
            Feel free to reach out through the form or via social platforms. I'm always open to connect!
          </p>
          ...
          <div className="space-y-4 text-gray-400 text-sm">
            ...
            <p className="flex items-center gap-2">
              <FaPhoneAlt className="text-cyan-400" /> +880 1612 163711 (Call & WhatsApp)
            </p>
            <p className="flex items-center gap-2">
